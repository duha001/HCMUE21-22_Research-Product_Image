...
LEARNING_RATE = 1e-3
EPOCHS = 30
# Thu chay 300 - 500 lan
TRAIN_BATCH_SIZE = 5  # Let's see, I don't have GPU, Google Colab is best hope
TEST_BATCH_SIZE = 5  # Let's see, I don't have GPU, Google Colab is best hope
FULL_BATCH_SIZE = 5
